...
component=3
method_name=$method"_"$component"comp_reg0prec01mu_100k_ncthr"$noncontact_thr
coupling_prior_parameters_file="/usr/users/svorber/work/data/bayesian_framework/mle_for_couplingPrior_cath4.1/"$maxent_method"/"$component"/reg_prec0_mu01/diagonal_100000_nrcomponents"$component"_noncontactthr$noncontact_thr/parameters"
