...
import contact_prediction.coupling_prior.utils_coupling_prior
...
def main():
    ...
    log_df      = contact_prediction.coupling_prior.utils_coupling_prior.read_optimization_log_file(optimization_log_file)
    parameters  = contact_prediction.coupling_prior.utils_coupling_prior.read_parameter_file(parameter_file)
    settings    = contact_prediction.coupling_prior.utils_coupling_prior.read_settings_file(parameter_file + ".settings")
