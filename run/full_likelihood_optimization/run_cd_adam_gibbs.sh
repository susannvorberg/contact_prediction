...
#bash ~/opt/contactprediction/contact_prediction/run/full_likelihood_optimization/run_cd_adam_learningrate.sh 5
...
mat_dir="/usr/users/svorber/work/data/benchmark_contrastive_divergence/phd/adam/alpha_opt/"
...
do
    ...
    do
        ...
        then
            ...
            jobname=ccmpredpy_cd.adam.alpha$alpha.$name
