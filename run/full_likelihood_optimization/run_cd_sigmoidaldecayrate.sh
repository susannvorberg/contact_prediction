...
#
#   and optimize sigmoidal decay rate in [1e-4 1e-3 1e-2 1e-1]
#
###################################################################################################################
...
#bash ~/opt/contactprediction/contact_prediction/run/full_likelihood_optimization/run_cd_sigmoidaldecayrate.sh 5
...
mat_dir="/usr/users/svorber/work/data/benchmark_contrastive_divergence/phd/alpha0_neff_initzero/sig_decayrate/"
...
do
    ...
    do
        ...
        then
            ...
            jobname=ccmpredpy_cd.alpha0$alpha0.sig_decayrate$decay_rate.$name
