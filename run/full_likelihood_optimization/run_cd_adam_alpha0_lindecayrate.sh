...
#
#   and optimize linear decay rate
#
###################################################################################################################
...
#bash ~/opt/contactprediction/contact_prediction/run/full_likelihood_optimization/run_cd_adam_alpha0_lindecayrate.sh 5
...
mat_dir="/usr/users/svorber/work/data/benchmark_contrastive_divergence/phd/adam/alpha0_lin_decayrate/"
...
do
    ...
    do
        ...
        then
            ...
            echo "--------------------------------------------------"
            echo "alpha: 0"
            echo "lin deacy rate: $decay_rate"
            echo "log file: "$logfile
            echo $settings
            echo "--------------------------------------------------"
            echo " "

            jobname=ccmpredpy_cd.adam.alpha0.lin_decayrate$decay_rate.$name
