...
do
    ...
    ##> $PARAM_DIR"/"$classifier".log" 2>&1

done


#nr_contacts=50000
#for nr_noncontacts in 100000 150000 250000 500000;
#do
#
#    PARAM_DIR=$DATA/bayesian_framework/contact_prior/random_forest/new_pipeline_5folds/ratio_contact_noncontact/$classifier/$nr_contacts"contacts_"$nr_noncontacts"noncontacts/"
#    PLOT_DIR=$PLOTS/bayesian_framework/contact_prior/random_forest/new_pipeline_5folds/ratio_contact_noncontact/$classifier/$nr_contacts"contacts_"$nr_noncontacts"noncontacts/"
#
#
#    if [ ! -d "$PARAM_DIR" ]; then
#      mkdir $PARAM_DIR
...
#    settings=$settings" --contact_threshold 8 --non_contact_threshold 20"
#    settings=$settings" --max_nr_contacts 100 --max_nr_noncontacts 1000"
#
#    if [ "$classifier" == "random_forest" ];
#    then
#        settings=$settings" --random-forest --rf_nestimators 1000 --rf_min_samples_leaf 1 --rf_criterion entropy --rf_min_samples_split 100 --rf_max_depth 100 --rf_class_weight balanced"
...
#
#    echo "Settings: "$settings
#    jobname=train.$classifier.noncontacts$nr_noncontacts
#    bsub -W 48:00 -q mpi -m "mpi mpi2 mpi3_all hh sa" -n 8 -R span[hosts=1] -a openmp  -J $jobname -o job-$jobname-%J.out python $CONTACT_PREDICTION_PATH/contact_prior/train_RF.py $settings
#
#done
...
#nr_contacts=50000
#nr_noncontacts=250000
#for noncontactthreshold in 8 15 20;
#do
#
#    PARAM_DIR=$DATA/bayesian_framework/contact_prior/random_forest/new_pipeline_5folds/noncontact_threshold/$classifier/$nr_contacts"contacts_"$nr_noncontacts"noncontacts"$noncontactthreshold"noncontactthreshold/"
#    PLOT_DIR=$PLOTS/bayesian_framework/contact_prior/random_forest/new_pipeline_5folds/noncontact_threshold/$classifier/$nr_contacts"contacts_"$nr_noncontacts"noncontacts"$noncontactthreshold"noncontactthreshold/"
#
#
#    if [ ! -d "$PARAM_DIR" ]; then
#      mkdir $PARAM_DIR
...
#    echo "nr_contacts= "$nr_contacts
#    echo "nr_noncontacts= "$nr_noncontacts
#    echo "noncontact threshold= "$noncontactthreshold
#    echo "classifier= "$classifier
#    echo "--------------------------------------------------------------------------------"
#
#
...
#
#    echo "Settings: "$settings
#    jobname=train.$classifier.ncthreshold$noncontactthreshold
#    bsub -W 48:00 -q mpi -m "mpi mpi2 mpi3_all hh sa" -n 8 -R span[hosts=1] -a openmp  -J $jobname -o job-$jobname-%J.out python $CONTACT_PREDICTION_PATH/contact_prior/train_RF.py $settings
#
#done