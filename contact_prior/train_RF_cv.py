...
def parse_args():
    ...
    parser.add_argument("--cv-option",  dest="cv_option", type=str, choices=['window_size', 'non_contact_threshold', 'ratio_contact_noncontact'], default='window_size', help="Do cross-validation for this dataset setting")
...
def main():
    ...
    cv_options = {
        'window_size': [3,5,9,15],
        'non_contact_threshold': [8, 15, 25],
        'ratio_contact_noncontact': [2, 5, 10, 20]
    }
    ...
    contact_prior_model.evaluate_cv(plot_dir,  predictions_cv, predictions_testset, predictions_testset_proteinwise)
